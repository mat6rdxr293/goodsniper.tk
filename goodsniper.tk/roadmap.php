...
<meta property="og:url" content="https://goodsniper.tk" />
<meta property="og:locale" content="en_US"/>
<meta property="og:type" content="website" />
<meta property="og:site_name" content="RPCS3" />

<meta name="twitter:title" content="GoodSNIPER - Наши цели">
	...
	<div class="banner-con-container darkmode-header">
		...
		<div class='banner-con-title fade-up-onstart'>
			...
			<div class='banner-tx2-title fade-up-onstart'>
				<p>
					 Цели проекта "SniperOS", заключаются в безопасности, открытости и многофункциональности. Мы даем возможность просмотреть и редактировать исходный код.
				</p>
			</div>
		</div>
	</div>
